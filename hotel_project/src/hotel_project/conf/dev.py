...
os.environ.setdefault(
    "SECRET_KEY",
    "django-insecure--iju5^(gw&je9m5_q)mv%*0%f0lu!mgu9pj@x1b!kgp!!vrsy#",
)
os.environ.setdefault("IS_HTTPS", "no")
os.environ.setdefault("VERSION_TAG", "dev")

os.environ.setdefault("DB_NAME", "hotel_project")
os.environ.setdefault("DB_USER", "hotel_project")
os.environ.setdefault("DB_PASSWORD", "hotel_project")
