...
from .views import HotelListView, clear_hotels, HotelDetailView, ReservationFormView, get_room_and_hotel, get_hotel_and_room
...
urlpatterns = [
    ...
    path('reservation/date/<int:pk>/<int:Rpk>', get_room_and_hotel, name='reservation_date'),
