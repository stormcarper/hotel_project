...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", "hotel_project"),
        "USER": config("DB_USER", "hotel_project"),
        "PASSWORD": config("DB_PASSWORD", "hotel_project"),
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "hotel_project.utils.context_processors.settings",
            ],
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": LOGGING_DIR / "hotel_project.log",
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
...
AUTHENTICATION_BACKENDS = [
    ...
    "hotel_project.accounts.backends.UserModelEmailBackend",
    "django.contrib.auth.backends.ModelBackend",
]

SESSION_COOKIE_NAME = "hotel_project_sessionid"
...
CSRF_FAILURE_VIEW = "hotel_project.accounts.views.csrf_failure"
...
ADMIN_INDEX_DISPLAY_DROP_DOWN_MENU_CONDITION_FUNCTION = (
    "hotel_project.utils.django_two_factor_auth.should_display_dropdown_menu"
)
...
TWO_FACTOR_WEBAUTHN_RP_NAME = "hotel_project"
...
ELASTIC_APM = {
    "SERVICE_NAME": f"hotel_project {ENVIRONMENT}",
